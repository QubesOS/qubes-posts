---
layout: post
title: "Fedora 42 approaching end of life"
categories: announcements
---

Fedora 42 is currently [scheduled](https://fedorapeople.org/groups/schedule/f-42/f-42-key-tasks.html) to reach [end of life (EOL)](https://fedoraproject.org/wiki/End_of_life) on 2026-05-13 (two months from the date of this announcement). Please upgrade all of your Fedora templates and standalones by that date. For more information, see [Upgrading to avoid EOL](https://doc.qubes-os.org/en/latest/user/how-to-guides/how-to-update.html#upgrading-to-avoid-eol).

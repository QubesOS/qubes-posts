---
layout: post
title: "Fedora 44 templates available"
categories: announcements
---

The following new [Fedora 44 templates](https://doc.qubes-os.org/en/latest/user/templates/fedora/fedora.html) are now available for Qubes OS 4.3:

- `fedora-44-xfce` --- default Fedora template with the [Xfce](https://xfce.org/) desktop environment
- `fedora-44-gnome` --- alternative Fedora template with the [GNOME](https://www.gnome.org/) desktop environment
- `fedora-44-minimal` --- [minimal template](https://doc.qubes-os.org/en/latest/user/templates/minimal-templates.html) for advanced users

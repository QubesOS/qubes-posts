...
The following new [Fedora 42 templates](https://doc.qubes-os.org/en/latest/user/templates/fedora/fedora.html) are now available for Qubes OS 4.2:

- `fedora-42-xfce` (default Fedora template with the [Xfce](https://xfce.org/) desktop environment)
- `fedora-42` (alternative Fedora template with the [GNOME](https://www.gnome.org/) desktop environment)
- `fedora-42-minimal` ([minimal template](https://doc.qubes-os.org/en/latest/user/templates/minimal-templates.html) for advanced users)

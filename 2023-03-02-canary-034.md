---
layout: post
title: "Qubes Canary 034"
categories: security
---

_**Editor's note:** An earlier version of this post mistakenly contained the text of an older canary. This has been corrected below. As always, we encourage readers to verify the cryptographic signatures on canaries, which can always be found in the [Qubes security pack (qubes-secpack)](/security/pack/)._

We have published a new [Qubes canary](/security/canary/). The text of this canary is reproduced below. This canary and its accompanying cryptographic signatures will always be available in the [Qubes security pack (qubes-secpack)](/security/pack/).
...
000000000000000000037ab2816f3100fc37acee47a63571b5d3b7ca72145906

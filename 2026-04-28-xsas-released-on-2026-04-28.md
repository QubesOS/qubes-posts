---
layout: post
title: "XSAs released on 2026-04-28"
categories: security
---
...
- [XSA-483](https://xenbits.xen.org/xsa/advisory-483.html)
  - Qubes OS does not use oxenstored.
- [XSA-484](https://xenbits.xen.org/xsa/advisory-484.html)
  - Denial of service only
- [XSA-485](https://xenbits.xen.org/xsa/advisory-485.html)
  - In-VM attack only
- [XSA-486](https://xenbits.xen.org/xsa/advisory-486.html)
  - Grant table v2 is disabled in Qubes OS.
- [XSA-487](https://xenbits.xen.org/xsa/advisory-487.html)
  - In-VM attack only
- [XSA-489](https://xenbits.xen.org/xsa/advisory-489.html)

---
layout: post
title: "XSAs released on 2026-03-17"
categories: security
---
...
- [XSA-480](https://xenbits.xen.org/xsa/advisory-480.html)
  - See [QSB-110](https://www.qubes-os.org/news/2026/03/17/qsb-110/)

## XSAs that DO NOT affect the security of Qubes OS

The following XSAs **do not affect** the security of Qubes OS, and no user action is necessary:

- [XSA-481](https://xenbits.xen.org/xsa/advisory-481.html)
